module.exports = {
    siteUrl: `https://deployn.de`, // Site domain. Do not include a trailing slash!

    postsPerPage: 12, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)

    siteTitleMeta: `Deployn Blog`, // This allows an alternative site title for meta data for pages.
    ...
    shortTitle: `Deployn Blog`, // Used for App manifest e.g. Mobile Home Screen
